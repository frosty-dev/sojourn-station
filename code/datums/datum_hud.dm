...
/datum/hud/human
	...
	HUDoverlays = list(
		...
		"damageoverlay"  = list("type" = /obj/screen/damageoverlay,   "loc" = "1,2:-32", "icon" =  'icons/mob/screen1_full.dmi'),
		"glassesoverlay" = list("type" = /obj/screen/glasses_overlay, "loc" = "1,2:-32", "icon_state" = "blank"),
	)
...
//corner buttons
	"jump"               = list("type" = /obj/screen/jump,              "loc" = "EAST,BOTTOM+2:-6",   "minloc" = "RIGHT,3:-6",   "background" = "back17-1"),
	"look up"            = list("type" = /obj/screen/look_up,           "loc" = "EAST-1,BOTTOM+1:13", "minloc" = "RIGHT-1,2:13", "background" = "back17-1"),
	"throw"              = list("type" = /obj/screen/HUDthrow,          "loc" = "EAST,BOTTOM+1:13",   "minloc" = "RIGHT,2:13",   "background" = "back17-1"),
	"pull"               = list("type" = /obj/screen/pull,              "loc" = "EAST-2,BOTTOM+1:13", "minloc" = "RIGHT-2,2:13", "background" = "back17-1"),
	"drop"               = list("type" = /obj/screen/drop,              "loc" = "EAST,BOTTOM+1",      "minloc" = "RIGHT,2",      "background" = "back17-1"),
	"resist"             = list("type" = /obj/screen/resist,            "loc" = "EAST-2,BOTTOM+1",    "minloc" = "RIGHT-2,2",    "background" = "back17-1"),
	"rest"               = list("type" = /obj/screen/rest,              "loc" = "EAST-1,BOTTOM+1",    "minloc" = "RIGHT-1,2",    "background" = "back17-1"),
	"move intent"        = list("type" = /obj/screen/mov_intent,        "loc" = "EAST-1,BOTTOM",      "minloc" = "RIGHT-1,1",    "background" = "back1"),
	"implant bionics"    = list("type" = /obj/screen/implant_bionics,   "loc" = "EAST-3,BOTTOM",      "minloc" = "12,1",         "background" = "back13"),
	"craft menu"         = list("type" = /obj/screen/craft_menu,        "loc" = "EAST-3,BOTTOM+1",    "minloc" = "12:16,1",      "background" = "back13"),
	"wield"              = list("type" = /obj/screen/wield,             "loc" = "EAST-3:16,BOTTOM+1", "minloc" = "12:16,2",      "background" = "back13"),
	"intent"             = list("type" = /obj/screen/intent,            "loc" = "EAST-2,BOTTOM",      "minloc" = "13,1",         "background" = "back1"),
	"damage zone"        = list("type" = /obj/screen/zone_sel,          "loc" = "EAST,BOTTOM",        "minloc" = "RIGHT,1",      "background" = "back1"),
//hand buttons
	"equip"              = list("type" = /obj/screen/equip,             "loc" = "8,2",                "minloc" = "7,2",          "background" = "back14-l"),
	"swap hand"          = list("type" = /obj/screen/swap,              "loc" = "8,2",                "minloc" = "7,2"),
	...
	"toggle invetory"    = list("type" = /obj/screen/toggle_invetory,   "loc" = "2,1",                "minloc" = "1,1",          "background" = "back1")

	)

	slot_data = list (
		"Uniform" 		= list("loc" = "2,2",  "minloc" = "1,2",   "state" = "center",  "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Suit" 			= list("loc" = "3,2",  "minloc" = "2,2",   "state" = "equip",   "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Mask" 			= list("loc" = "3,3",  "minloc" = "2,3",   "state" = "mask",    "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Gloves" 		= list("loc" = "4,2",  "minloc" = "3,2",   "state" = "gloves",  "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Glasses" 		= list("loc" = "2,3",  "minloc" = "1,3",   "state" = "glasses", "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Left Ear" 		= list("loc" = "4,3",  "minloc" = "3,3",   "state" = "ears0",   "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Right Ear" 	= list("loc" = "4,4",  "minloc" = "3,4",   "state" = "ears1",   "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Hat" 			= list("loc" = "3,4",  "minloc" = "2,4",   "state" = "hair",    "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Shoes" 		= list("loc" = "3,1",  "minloc" = "2,1",   "state" = "shoes", 										"background" = "back1"),
		"Suit Storage" 	= list("loc" = "4,1",  "minloc" = "3,1",   "state" = "suit-belt", 									"background" = "back1"),
		"Back" 			= list("loc" = "7,1",  "minloc" = "6,1",   "state" = "back", 										"background" = "back1"),
		"ID" 			= list("loc" = "5,1",  "minloc" = "4,1",   "state" = "id",											"background" = "back1"),
		"Left Pocket" 	= list("loc" = "10,1", "minloc" = "9,1",   "state" = "pocket_l", 									"background" = "back1"),
		"Right Pocket" 	= list("loc" = "11,1", "minloc" = "10,1",  "state" = "pocket_r", 									"background" = "back1"),
		"Belt" 			= list("loc" = "6,1",  "minloc" = "5,1",   "state" = "belt", 										"background" = "back1"),
		"Left Hand" 	= list("loc" = "9,1",  "minloc" = "8,1",   "state" = "hand-l", "type" = /obj/screen/inventory/hand, "background" = "back1"),
		"Right Hand" 	= list("loc" = "8,1",  "minloc" = "7,1",   "state" = "hand-r", "type" = /obj/screen/inventory/hand, "background" = "back1")
		)

	HUDfrippery = list(
		list("loc" = "1,1", "icon_state" = "frame0-3", ),
		list("loc" = "1,1", "icon_state" = "frame3-4", ),
		list("loc" = "1,2", "icon_state" = "frame2-2",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "1,3", "icon_state" = "frame2-3",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "1,4", "icon_state" = "frame2-1",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "1,2", "icon_state" = "frame1-3", "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "1,3", "icon_state" = "frame1-7",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "1,4", "icon_state" = "frame1-5",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "5,2", "icon_state" = "frame1-2",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "5,3", "icon_state" = "frame1-6",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "5,4", "icon_state" = "frame1-4", "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "8,2:13", "icon_state" = "frame1-8"),
		list("loc" = "9,2:13", "icon_state" = "frame1-1"),
		list("loc" = "12,1", "icon_state" = "frame3-2"),
		list("loc" = "12,1", "icon_state" = "frame0-2"),
		list("loc" = "12,1", "icon_state" = "frame0-3"),
