...
/datum/event/electrical_storm/announce()
	command_announcement.Announce("Внимание, Электрический шторм обнаружен в районе дислокации колонии Надежда, инженерному составу рекомендуется провести проверку оборудования.", "Электрический Шторм", new_sound = 'sound/AI/e_storm_ru.ogg')
