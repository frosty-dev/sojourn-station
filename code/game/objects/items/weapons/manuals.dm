...
/obj/item/weapon/book/manual/engineering_particle_accelerator/New()
	...
	dat = {"<html>
				...
				<ol>
					...
					<li><span class='warning'><b>When the singularity reaches a large enough size so it starts moving on it's own set the speed down to 0, but don't shut it off</b></font></li>
...
/obj/item/weapon/book/manual/engineering_singularity_safety
	...
	dat = {"<html>
				...
				<ol>
					<li><b><span class='warning'>PANIC!</font></b></li>
...
/obj/item/weapon/book/manual/evaguide
	...
	dat = {"<html>
				...
				These suits generally only fit one species. Arasaka's are usually human-fitting by default, but there's equipment that can make modifications to the hardsuits to fit them to other species.<BR><BR>
...
//neotheology
/obj/item/weapon/book/manual/wiki/neotheology_cloning //TODO: Completely change this to be ARA-oriented.
