...
/obj/mecha/combat/durand/relaymove(mob/user,direction)
	if(defence)
		if(world.time - last_message > 20)
			src.occupant_message("<span class='warning'>Unable to move while in defence mode</font>")
...
/obj/mecha/combat/durand/verb/defence_mode()
	...
	if(defence)
		...
		deflect_chance -= def_boost
		src.occupant_message("<span class='warning'>You disable [src] defence mode.</font>")
