...
/datum/map_template
	...
	var/cost = null 
	// The map generator has a set 'budget' it spends to place down different submaps. 
	// It will pick available submaps randomly until it runs out. The cost of a submap 
	// should roughly corrispond with several factors such as size, loot, difficulty, 
	// desired scarcity, etc. Set to -1 to force the submap to always be made.
