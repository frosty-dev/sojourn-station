...
/obj/singularity/proc/admin_investigate_setup()
	...
	investigate_log("was created. [count ? "" : "<span class='warning'>No containment fields were active.</font>"]", I_SINGULO)
...
/obj/singularity/proc/expand(var/force_size = 0, var/growing = 1)
	...
	if (current_size == allowed_size)
		investigate_log("<span class='warning'>grew to size [current_size].</font>", I_SINGULO)
		return 1
